...
knowledge3 = And(
    ...
    # Implication(BKnight, Or(Implication(AKnave, Not(AKnave)))),
...
# loops over all puzzles, and uses model_checking to compute, given the knowledge for that puzzle,
# whether each character is a knight or knave 
def main():
